...
trait FieldProcessor
{
    ...
    /**
     * processFieldExtensions applies additional field processing,
     * intended as an extension point for subclasses
     */
    protected function processFieldExtensions(array $fields)
    {
    }
}
